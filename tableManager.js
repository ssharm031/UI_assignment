        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                // div num rows
                var numrowsDiv =
                    '<div id="for_numrows" class="for_numrows" style="display: none;"><label for="numrows">' +
            ...
            **/
            if (pagination === true || Table.hasClass("tablePagination")) {
                ...
                var pagesDiv =
                    '<div id="pagesControllers" class="pagesControllers" style="text-align:center"></div>';
        ...
        function appendPageControllers(nPages) {
            ...
            $("#pagesControllers").append(
                $("<button>", {
                    value: "prev",
                    text: "",
                    class: "pagecontroller pagecontroller-p fas fa-arrow-left",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
            ...
            $("#pagesControllers").append(
                $("<button>", {
                    value: "next",
                    text: "",
                    class: "pagecontroller pagecontroller-n fas fa-arrow-right",
                })
            );
            // Last
            // $("#pagesControllers").append(
